                ...
                <form action="">
                  ...
                  <div className="confirm-input" onClick={e=>{
                   ...
                   if(e.currentTarget.querySelector("input").getAttribute("checked") === null){
                    ...
                    <label for="c1">I agree with sending an Marketing and newsletter emails. No spam, promissed!</label>
                  </div>
                  ...
                  <div className="confirm-input" onClick={e=>{
                   ...
                   if(e.currentTarget.querySelector("input").getAttribute("checked") === null){
                    ...
                    <input type="checkbox" />
                    <div className="checkmark" ></div>
                    <label for="c1">I agree with our <Link to="/terms-and-conditions" target="blank">terms and conditions</Link> and <Link target="blank" to="/privacy-policy">privacy policy.</Link></label>
                  </div>
